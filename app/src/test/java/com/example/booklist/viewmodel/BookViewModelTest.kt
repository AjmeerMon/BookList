...
import com.example.booklist.model.ImageLinks
...
import com.example.booklist.utils.UIState
...
class BookViewModelTest {
    ...
    fun laodBook_success() =  runBlockingTest {
        ...
        val randomBookResopnce = RandomBookResponse(listOf(RandomBook(VolumeInfo("Clean Code","A Handbook of Agile Software Craftsmanship",
    ...
    fun laodBook_failure() =  runBlockingTest {
        ...
        whenever(bookRepository.getRandomBook("")).thenReturn(Response.error(
            400,
            "{\"key\":[\"somestuff\"]}"
